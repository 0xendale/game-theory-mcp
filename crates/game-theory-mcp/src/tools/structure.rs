...
//!
//! Both halves of `game-theory-core`'s analysis come back from one call: a host asking
...
use game_theory_core::analyze::{analyze_structure, classify, Archetype, StructureReport};
use game_theory_core::error::GtError;
use game_theory_core::game::{Profile, ValidStrategicGame};
