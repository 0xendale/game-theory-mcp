...
fn kind_name(k: game_theory_core::game::PayoffKind) -> &'static str {
    match k {
        game_theory_core::game::PayoffKind::Ordinal => "ordinal",
        game_theory_core::game::PayoffKind::Cardinal => "cardinal",
    }
}
