...
//!
//! One tool, four concepts, three `game-theory-core` functions. `game-theory-core` deliberately
...
use game_theory_core::error::GtError;
use game_theory_core::game::{NodeId, StrategyId};
use game_theory_core::solve::{
    verify_equilibrium, verify_mixed_nash, verify_spe, Concept, MixedStrategy,
};
