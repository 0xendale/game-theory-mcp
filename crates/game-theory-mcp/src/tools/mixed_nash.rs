...
//! cardinal game.
//!
//! `game-theory-core` enumerates equal-size support pairs and solves the indifference
...
//! on unequal-size supports; `game-theory-core` says so, and this layer forwards its
...
use game_theory_core::solve::{solve_mixed_nash, MixedEquilibrium};
...
/// is copied from what `game-theory-core` computed.
