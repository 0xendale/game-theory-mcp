...
use gt_core::analyze::{analyze_repeated_game, Punishment};
use gt_core::game::{StrategyId, ValidStrategicGame};
...
/// How deviation is punished. Only what `gt-core` implements is offered:
...
fn wire_report(
    ...
    report: gt_core::analyze::RepeatedGameReport,
    delta: Option<&gt_core::Rational>,
) -> RepeatedGameOutput {
    RepeatedGameOutput {
...
mod tests {
    ...
    fn an_unsustainable_target_reports_no_threshold_and_says_why() {
        ...
        // gt-core's explanation must reach the caller, not be swallowed.
