...
//!
//! `gt-core` already refuses to break ties, so this layer's only job is
...
use gt_core::game::{Node, NodeId, StrategyId, ValidExtensiveGame};
use gt_core::solve::solve_backward_induction;
...
mod tests {
    ...
    /// Mirrors `crates/gt-core/tests/fixtures/extensive/bonanno_fig_2_9_entry_game.json`.
