...
//!
//! ```
//! use game_theory_core::game::{MatrixForm, PayoffKind, StrategicGame, ValidStrategicGame};
...
//!
//! ```
//! use game_theory_core::game::Player;
//! use game_theory_core::{solve_backward_induction, ExtensiveGame, Node, PayoffKind, ValidExtensiveGame};
//!
